...
global beNice getkdTime kdq colorPlot cntLvls peakIntProfile finalScore peakStoreX peakStoreY
...
elseif number == 5 && questionAsked(number) == 0
    ...
    disp("")
    printf(dispOption("D","The peak of this residue has a higher intensity, because it just happens to be so due to the noise."))
    disp("")
