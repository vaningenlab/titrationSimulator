...
global acronymProtein acronymLigand ligandDescriptor easyMode cq numQuestions instructorMail sendEmail
    ...
    elseif number == 4 && questionAsked(number) == 0
        ...
        disp("");
        disp("EXPLANATION:")
        disp("Clearly the ligand concentration needed to saturate the protein depends on the affinity.")
